...
#include <utility/QCiThemeVariable.hpp>
...
void OBSApp::FindThemes()
{
	...
	{
		const std::string themeDir = App()->userConfigLocation.u8string() + "/" OBS_USER_DATA_DIR "/themes";
...
bool OBSApp::SetTheme(const QString &name)
{
	...
	string filename(OBS_USER_DATA_DIR "/themes/");
...
bool OBSApp::InitTheme()
{
	...
	char userDir[512];
	if (GetAppConfigPath(userDir, sizeof(userDir), OBS_USER_DATA_DIR "/themes")) {
